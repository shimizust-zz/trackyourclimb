...
<html>
	...
	<body>
		...
		<form action="workout-result.php" method="post" id="workout-form" name="workout-form" onsubmit="return dateCheck()">
		<!--Gym Picker-->
		
		<div class="container-fluid" id="gym-date-pickers">
			<div id = "gym-picker">
				...
				<label for="gymid"><p style="display:inline" id="labelforclimbingarea">Gym: </p><a href="add-gym.php" id="add-gym-text">
				...
				<input type='checkbox' name='default-gym' checked><p style="display:inline" id="defaultclimbingarea">Set as default gym</p>
			</div>
			
			
			<input id="main_gymid" value=<?php echo empty($main_gymid) ? 0 : $main_gymid ?> style="display:none"> 
			<input id="main_cragid" value=<?php echo empty($main_cragid) ? 0 : $main_cragid ?> style="display:none"> 
			<input id="main_climbingid" value=<?php echo empty($main_gymid) ? 0 : $main_gymid ?> style="display:none"> 
			
			<input id="climbingAreaType" value="1" name="gym-indoor" type="number" style="display:none">
			...
			<div data-content="Points calculation detailed <a href='statsfaq.php#points-calculation' target='_blank'>here</a>" class="alert alert-info fixedElement" id="current-points">
				<h3>Current Points: <b id="current-point-total">0</b></h3>
			</div>
			
		</div>
		<script>
			// Make popover persist when hovering over the points box, as well as the popover itself
			$("#current-points").popover({ trigger: "manual" , html: true, animation:true})
		...
		<div class="panel-group" id="accordion">
			...
			<?php echo $show_boulder ? '' : 'style="display:none'?>">
				<div class="panel-heading">
					<h4 class="panel-title" id="workoutinput-panel-title"><a data-toggle="collapse" data-target="#collapseOne" href="#collapseOne"> <span class="glyphicon glyphicon-chevron-down"></span> Bouldering </a></h4>
				</div>
				<div id="collapseOne" class="panel-collapse collapse" id="boulderinput">
					<div class="panel-body">
						...
						<div>
							...
							<textarea name="boulderNotes" cols="50" rows="5"></textarea>
						</div>
					</div>
				</div>
			</div>
			<div class = "panel panel-default" 
				...
				<div class="panel-heading">
					<h4 class="panel-title" id="workoutinput-panel-title"><a data-toggle="collapse" data-target="#collapseTwo" href="#collapseTwo"> <span class="glyphicon glyphicon-chevron-down"></span> Top-Roping </a></h4>
				</div>
				<div id="collapseTwo" class="panel-collapse collapse <?php echo $show_boulder ? '' : 'in'?>">
					<div class="panel-body">
						...
						<div>
							...
							<textarea name="TRNotes" cols="50" rows="5"></textarea>
						</div>
					</div>
				</div>
			</div>
			<div class = "panel panel-default"
				...
				<div class="panel-heading">
					<h4 class="panel-title" id="workoutinput-panel-title"><a data-toggle="collapse" data-target="#collapseThree" href="#collapseThree"> <span class="glyphicon glyphicon-chevron-down"></span> Leading </a></h4>
				</div>
				<div id="collapseThree" class="panel-collapse collapse <?php echo (!$show_boulder)&&(!$show_TR) ? 'in' : ''?>">
					<div class="panel-body">
						...
						<div>
							<p>Leading Notes: </p>
							<textarea name="LeadNotes" cols="50" rows="5"></textarea>
						</div>
					</div>
				</div>
			</div>
			<div class = "panel panel-default">
				<div class="panel-heading">
					<h4 class="panel-title" id="workoutinput-panel-title"><a data-toggle="collapse" data-target="#collapseFour" href="#collapseFour"> <span class="glyphicon glyphicon-chevron-down"></span> Other (Hangboard, Campus board, etc.) </a></h4>
				</div>
				<div id="collapseFour" class="panel-collapse collapse">
					<div class="panel-body">
						<div>
							<p>Other Notes: </p>
							<textarea name="OtherNotes" cols="50" rows="6"></textarea>
						</div>
					</div>
				</div>
			</div>
